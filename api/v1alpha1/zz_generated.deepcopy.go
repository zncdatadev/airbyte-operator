...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlobalLogSpec) DeepCopyInto(out *GlobalLogSpec) {
	*out = *in
	if in.Minio != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalLogSpec.
func (in *GlobalLogSpec) DeepCopy() *GlobalLogSpec {
	if in == nil {
		return nil
	}
	out := new(GlobalLogSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecretParam) DeepCopyInto(out *SecretParam) {
	*out = *in
	if in.AirbyteSecrets != nil {
		in, out := &in.AirbyteSecrets, &out.AirbyteSecrets
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.GcsLogCreds != nil {
		in, out := &in.GcsLogCreds, &out.GcsLogCreds
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
