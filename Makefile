...
# zncdata.net/airbyte-operator-bundle:$VERSION and zncdata.net/airbyte-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= $(RETISTRY)/airbyte-operator
...
IMG ?= $(RETISTRY)/airbyte-operator:$(VERSION)
